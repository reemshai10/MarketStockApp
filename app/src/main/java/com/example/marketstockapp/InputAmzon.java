...
public class InputAmzon extends AppCompatActivity {
    ...
    DatabaseReference AmzonRefOne = mRootRef.child("amzon");
    ...
    protected void onStart() {
        ...
        AmzonRefOne.addValueEventListener(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                String Number = snapshot.getValue(String.class);
